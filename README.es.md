...
Para una explicación exhaustiva de cada línea de código y patrón utilizado, consulta la [Documentación Detallada de Arquitectura](docs/architecture.md).
...
```json
{
  "mcpServers": {
    "binance-mcp": {
      "command": "/ruta/a/tu/binance-mcp-go/binance-mcp",
      "env": {
        "BINANCE_API_KEY": "tu_api_key_aqui",
        "BINANCE_SECRET_KEY": "tu_secret_key_aqui",
        "BINANCE_TESTNET": "true",
        "BINANCE_FUTURES_API_KEY": "tu_futures_api_key_aqui",
        "BINANCE_FUTURES_SECRET_KEY": "tu_futures_secret_key_aqui"
      }
    }
  }
}
